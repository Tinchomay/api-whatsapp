<div class=" px-6" class="p-4">
    ...
    <h1 class="text-center text-2xl font-bold mb-8">Crear documento</h1>
            ...
            @endif" >
                ...
                <div class="flex w-full gap-4">
                    <div class="w-full">
                        ...
                        <x-text-input id="numde" class="block mt-1 w-full" type="text" wire:model="numde" :value="old('numde')" required autofocus />
                        <x-input-error :messages="$errors->get('numde')" class="mt-2" />
                    </div>
                    <div class="w-full">
                        <x-input-label for="naciu" :value="__('Nombre')" />
                        <x-text-input id="naciu" class="block mt-1 w-full" type="text" wire:model="naciu" :value="old('naciu')" required autofocus />
                ...
                <div class="flex w-full gap-4 mt-4">
                    <div class="w-full">
                        ...
                        <x-text-input id="tiden" class="block mt-1 w-full" type="text" wire:model="tiden" :value="old('tiden')" required autofocus />
                        <x-input-error :messages="$errors->get('tiden')" class="mt-2" />
                    </div>
                    <div class="w-full">
                        <x-input-label for="vemar" :value="__('Marca')" />
                        <x-text-input id="vemar" class="block mt-1 w-full" type="text" wire:model="vemar" :value="old('vemar')" required autofocus />
                        <x-input-error :messages="$errors->get('vemar')" class="mt-2" />
                    </div>
                    <div class="w-full">
                        <x-input-label for="vepla" :value="__('Placas')" />
                        <x-text-input id="vepla" class="block mt-1 w-full" type="text" wire:model="vepla" :value="old('vepla')" required autofocus />
